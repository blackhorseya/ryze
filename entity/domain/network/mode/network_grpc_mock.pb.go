...
func (m *MockNetworkServiceClient) GetNetworkStats(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*NetworkStats, error) {
	m.ctrl.T.Helper()
...
func (m *MockNetworkServiceClient) GetNodeStatus(ctx context.Context, in *GetNodeStatusRequest, opts ...grpc.CallOption) (*NodeStatus, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
...
// GetNetworkStats mocks base method.
func (m *MockNetworkServiceServer) GetNetworkStats(ctx context.Context, in *emptypb.Empty) (*NetworkStats, error) {
	m.ctrl.T.Helper()
...
// GetNodeStatus mocks base method.
func (m *MockNetworkServiceServer) GetNodeStatus(ctx context.Context, in *GetNodeStatusRequest) (*NodeStatus, error) {
	m.ctrl.T.Helper()
