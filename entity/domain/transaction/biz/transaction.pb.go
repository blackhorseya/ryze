...
func (x *TransactionListRequest) GetPage() int64 {
	if x != nil {
		return x.Page
	}
	return 0
...
func (x *TransactionListRequest) GetPageSize() int64 {
	if x != nil {
		return x.PageSize
	}
	return 0
...
var file_domain_transaction_biz_transaction_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0x49, 0x0a, 0x16, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69,
	...
	0x6e, 0x2e, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x4c, 0x69, 0x73,
...
var file_domain_transaction_biz_transaction_proto_goTypes = []any{
	(*TransactionListRequest)(nil), // 0: transaction.TransactionListRequest
...
var file_domain_transaction_biz_transaction_proto_depIdxs = []int32{
	...
	0, // 1: transaction.TransactionService.ListTransactions:input_type -> transaction.TransactionListRequest
